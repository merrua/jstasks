...
// Your task is to find out what this is
// and write a function that will add two strings together,
...
// If one of the arguments is a number your code must coerce
//  it into being a string.

function joinStrings(string1, string2) {
  return `${string1.toString()} ${string2.toString()}`;
}

console.log(joinStrings(1, 2));
console.log(joinStrings("test1", "test2"));
