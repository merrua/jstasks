...
// where the values of the properties are equal when
//  compared with a recursive call to deepEqual.

// To find out whether values should be compared
//  directly (use the === operator for that)
// or have their properties compared, you can use
// the typeof operator.
...
// let ob2 = { k1: { k2: "test1" }, object: 2 };
// console.log(deepEqual(ob2, { k1: { k2: "test1" }, object: 2 }));
