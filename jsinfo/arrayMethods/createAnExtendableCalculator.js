...
// that takes a string like "1 + 2" in the
// format “NUMBER operator NUMBER” (space-delimited)
...
// It takes the operator name and
...
// function Calculator(str1) {
//   let operator = "";
//   let firstPart = 0;
//   let secPart = 0;

//   this.calculate = function (str1) {
//     if (str1.includes("+")) {
//       operator = "+";
...
//       secPart = parts[1];
//       console.log(
//         `${firstPart} ${operator} ${secPart} = ${
//           Number(firstPart) + Number(secPart)
//         }`
//       );
//       return Number(firstPart) + Number(secPart);
...
// let calc = new Calculator();
// alert(calc.calculate("3 + 7")); // 10
// alert(calc.calculate("7 - 2")); // 5
// alert(calc.calculate("3 * 7")); // 21
// alert(calc.calculate("70 / 3")); // 23.333
